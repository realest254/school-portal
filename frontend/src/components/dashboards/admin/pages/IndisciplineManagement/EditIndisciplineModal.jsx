...
const EditIndisciplineModal = ({ visible, onCancel, onSubmit, initialValues }) => {
  ...
  useEffect(() => {
    if (visible && initialValues) {
      form.setFieldsValue({
        ...initialValues,
        incidentDate: moment(initialValues.incidentDate),
      });
    }
...
export default EditIndisciplineModal;
