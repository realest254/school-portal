...
const DeleteStudentModal = ({ visible, onCancel, onConfirm, studentName }) => {
    ...
    >
      <div className="p-1">
        <p className={`text-base mb-6 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
          Are you sure you want to delete student <span className="font-semibold">{studentName}</span>? This action cannot be undone.
        </p>
